    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Bulk Delete Instagram Data</li>
        </ol>
...
$('document').ready(function() {
    ...
    //        alert(youtube);
            WRN_PROFILE_DELETE = "Are you sure you want to delete "+youtube.length+" instagram influencer?";  
            var checked = confirm(WRN_PROFILE_DELETE);  
            if(checked == true) {			
                var selected_values = youtube.join(","); 
                $.ajax({ 
                    type: "POST",  
                    url: "delete-instagram-bulk.php",  
                    cache:false,  
                    data: 'yt_id='+selected_values,  
                    success: function(response) {	
                        // remove deleted employee rows
                        var yt_ids = response.split(",");
                        alert(youtube.length+" instagram influencer deleted");
