...
.btn-submit {
	...
	margin: 30px 0px;
        ...
        <div class="card-header bg-dark text-white">
                   ...
                   Instagram Data <span style="float: right;"><a class="btn btn-danger" id="showfilter" href="javascript:void(0);"><i class="fas fa-filter"></i> Special Filters</a></span>
                    </div>
<!--
...
<!--                    <th>Sr. No.</th>-->
                ...
                <tbody>
                  <?php 
$table_data = "SELECT * FROM `instagram` WHERE (followers BETWEEN '$minsub' AND '$maxsub') AND (avg_views BETWEEN '$minviews' AND '$maxviews') AND (avg_likes BETWEEN '$minlikes' AND '$maxlikes');";
