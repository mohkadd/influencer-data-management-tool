    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Import Instagram Data</li>
        </ol>
...
<!--                        <p><span class="text-danger"><strong>Note: Make sure each profile url excel you are uploading is not present in system database, otherwise data importing will be failed due to already existing data.</strong></span></p>-->
                  ...
                  <a href="import-instagram-data-template.xlsx" class="btn btn-success" id="download" download>Download Excel Template</a>
                </form>
            </div>
          </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Import Instagram Data via Excel</div>
          <div class="card-body">
            <div class="userform">
                <form name="importinstagram" id="importinstagram" method="post" action="addinstagram.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <span class="text-danger" id="msgerror" style="display: none;"><strong>Data Imported Successfully by ignoring duplicate entries</strong></span>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data == 'duplicate'){
                    $("#submitfile").prop("disabled",false);
                    $("#submitfile").text("Import");
                    alert("Data Imported Successfully by ignoring duplicate entry");
                    $("#importinstagram")[0].reset();
