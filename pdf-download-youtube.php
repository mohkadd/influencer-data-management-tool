    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Generate PDF Data</li>
        </ol>
        ...
        <div class="card-header bg-dark text-white">
                   ...
                   PDF Download <span style="float: right;">
                   
                   <strong><span class="rows_selected" id="select_count">0 Selected </span></strong> 
                   <button type="submit" name="internal" class="btn btn-primary" id="delete_records"><i class="fas fa-download"></i> Internal PDF</button>
                   <button type="submit" name="external" class="btn btn-success" id="delete_records1"><i class="fas fa-download"></i> External PDF</button>
                   <br>
<!--                   <a class="btn btn-success" id="delete_records1"><i class="fas fa-download"></i> External PDF</a>-->
                    </span>
                    </div>
<!--
