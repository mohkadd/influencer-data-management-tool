...
$pdf->SetTitle('Instagram Influencer');
$pdf->SetSubject('Instagram Influencer');
$pdf->SetKeywords('Instagram Influencer, PDF');
...
// add a page
$pdf->AddPage('L');
$instagramid = $_POST['instagram-id'];
$ids = implode(',', $instagramid);
//fetching data from database
$table_data = "SELECT * FROM instagram WHERE id IN ($ids)";
...
if(isset($_POST['internal'])){
	...
	<div style="background-color:black;"><br>
		<img style="text-align:center;" src="../../images/user.jpg" class="img-radius" align="center" alt="User-Profile-Image"><br><br>
		...
		<table cellspacing="2" cellpadding="4" align="center">
			<tr class="txtred">
				<td colspan="3"><a style="text-decoration:none;color:#EF1931;font-size:17px;" target="_blank" href="'.decrypt($row->profile_url).'">Visit Profile</a></td>
			</tr>
		</table>
	</div>
	<br><br><br>
...
if(isset($_POST['external'])){
   while($row = $stmt1->fetch()){
	...
	<div style="background-color:black;"><br>
		...
		<table cellspacing="2" cellpadding="4" align="center">
			<tr class="txtred">
				<td colspan="3"><a style="text-decoration:none;color:red;font-size:17px;" target="_blank" href="'.decrypt($row->profile_url).'">Visit Profile</a></td>
			</tr>
		</table>
	</div>
	<br><br><br>
...
$pdf_file_name = $createdon."instagram-influencers.pdf";
