      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            <span class="text-danger"><strong>Important Note for Filter YouTube Data Requirement</strong></span></div>
          <div class="card-body">
            <div class="userform">
                      ...
                      <div class="col-md-12">
                        <ul>
                            ...
                            <li><strong>Below are the category range definition
                                <ul>
                                    <li>CAT - A : Celebrity OR Above 500k Subscribers</li>
                                    <li>CAT - B : Between 100k to 500k Subscribers</li>
                                    <li>CAT - C : Below 100k Subscribers</li>
                                </ul></strong>
                            </li>
                        </ul> 
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Filter Youtube Data </div>
          <div class="card-body">
            <div class="userform">
                <form name="addyoutube" id="addyoutube" method="post" action="bd-youtube-data.php">
                  <div class="form-group">
                    <div class="form-row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="genre" id="genre" class="form-control select2" required>
                              ...
                              <?php 
                              $state_query = "select distinct genre from youtube";
                  ...
                  <button class="btn btn-success" type="submit" name="filteryoutube" id="filteryoutube">Filter</button>
                </form>
            </div>
          </div>
          <!-- <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div> -->
